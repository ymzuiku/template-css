var m=Object.create,r=Object.defineProperty,h=Object.getPrototypeOf,y=Object.prototype.hasOwnProperty,f=Object.getOwnPropertyNames,k=Object.getOwnPropertyDescriptor;var w=e=>r(e,"__esModule",{value:!0});var x=(e,a)=>()=>(a||(a={exports:{}},e(a.exports,a)),a.exports);var $=(e,a,o)=>{if(a&&typeof a=="object"||typeof a=="function")for(let t of f(a))!y.call(e,t)&&t!=="default"&&r(e,t,{get:()=>a[t],enumerable:!(o=k(a,t))||o.enumerable});return e},z=e=>e&&e.__esModule?e:$(w(r(e!=null?m(h(e)):{},"default",{value:e,enumerable:!0})),e);var d=x((b,l)=>{(function(e,a){typeof b=="object"&&typeof l!="undefined"?l.exports=a():typeof define=="function"&&define.amd?define(a):(e=e||self).templateFn=a()})(b,function(){"use strict";return function(){for(var e=[],a=0;a<arguments.length;a++)e[a]=arguments[a];if(1<e.length){var o=e[0],t=e.slice(1),s="";return o.forEach(function(c,p){s+=c,t[p]&&(s+=t[p])}),s}return typeof e[0]=="string"?e[0]:e[0]?e[0].join(""):""}})});var i="",S=["primary","gray","red","orange","yellow","green","teal","blue","indigo","purple","pink","light","dark"];S.forEach(function(e){for(let a=1;a<=9;a++){i+=`--${e}-${a}00-0:rgba(let(--${e}-${a}00-base), 0); `;for(let o=1;o<=9;o+=1)i+=`--${e}-${a}00-${o}:rgba(let(--${e}-${a}00-base), 0.${o}); `;i+=`--${e}-${a}00:rgb(let(--${e}-${a}00-base)); `}});["white","black"].forEach(function(e){i+=`--${e}-0:rgba(let(--${e}-base), 0); `;for(let a=1;a<=9;a+=1)i+=`--${e}-${a}:rgba(let(--${e}-base), 0.${a}); `;i+=`--${e}:rgb(let(--${e}-base)); `});var M=`
  ...
  `,n=document.createElement("style");n.textContent=M;n.id="css-value-colors";document.head.append(n);var g=z(d()),u={};function E(...e){let a=g.default(...e);if(u[a])return;u[a]=!0;let o=document.createElement("style");o.innerHTML=a,document.head.append(o)}var j=E;export{j as default};
